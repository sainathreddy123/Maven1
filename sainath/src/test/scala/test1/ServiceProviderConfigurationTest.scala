...
import test1.reader.mycomponent.MyStreamReaderImpl
import test1.transformer.mycomponent.MyStreamTransformerImpl
import test1.writer.mycomponent.MyStreamWriterImpl
